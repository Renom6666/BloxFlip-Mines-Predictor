...
async def mines(ctx, round_id):
    ...
    if round_length < 36:
        await ctx.send(":x: Invalid round id :x:")
        ...
        pfp = 'https://tenor.com/view/sunset-anime-pretty-sky-gif-19364935'
        em = discord.Embed(color=0x11F1D3)
        em.set_thumbnail(url=pfp)
        em.set_footer(text="Made By RENØM#3940, Join https://discord.gg/ZzWc9D9Su6 ")
